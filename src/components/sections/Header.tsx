      ...
      <header className="container m-auto">
        ...
        <section className="mt-10 px-3 lg:flex items-center">
          <div className="flex flex-col gap-6 flex-[2] lg:gap-8">
            <h1 className="text-center text-xl font-semibold font-heading lg:text-left">
            ...
            <a
              href="#"
              className="bg-primary w-full block text-center text-white text-sm py-2 rounded-full shadow-lg lg:w-1/2 lg:py-3"
            >
          ...
          <img
            src={mockups}
            width={296}
            className="w-full p-3 mt-6 lg:mt-0 lg:flex-[3] lg:w-0 lg:max-w-xl"
            alt="Mockups"
          />
        </section>
      </header>
